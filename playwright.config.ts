...
export default defineConfig({
  ...
  /* Run the app before starting the tests. Locally, reuse the dev server
     for fast iteration; in CI, build and serve the real production bundle
     so tests exercise what actually ships, not dev-mode behavior. */
  webServer: {
